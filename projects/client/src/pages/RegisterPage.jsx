...
export default function Register() {
 ...
 const companyId = async () => {
  await api.get('/Companies', companyList).then((res) => {
     ...
     <Box>
      ...
      >
       ...
       <Input
        ...
        id="address"
       ></Input>
       <Box color={'red'} display={formik.errors.address ? 'box' : 'none'}>
       ...
       <Input
        ...
        id="password"
       ></Input>
       <Box color={'red'} display={formik.errors.password ? 'box' : 'none'}>
       ...
       <Box color={'red'} display={formik.errors.company_id ? 'box' : 'none'}>
