...
export default function Content() {
 ...
 async function getClock() {
  const attLog = await api.get('/attendancelog/today', {
 ...
 async function addClockIn() {
  await api.post('/attendancelog?user_id=' + userSelector.id);
  getClock();
 }
 async function addClockOut() {
  await api.patch('/attendancelog?user_id=' + userSelector.id);
  getClock();
 }
 ...
 async function uploadAvatar() {
  ...
  await api
   .post('/Users/image/v1/' + userSelector.id, formData)
 ...
 return (
  <Center h={'100vh'} w={'100vw'}>
   <Box id="boxLogin" w={'390px'} h={'844px'} maxH={'844px'}>
    <Box bg={'rgb(191,41,53)'} borderRadius={'30px'} paddingBottom={'20px'}>
     <Flex
      justifyContent={'end'}
      paddingRight={'15px'}
      paddingTop={'15px'}
     ...
     <Center justifyContent={'center'}>
      ...
      >
       ...
       <Center color={'white'}>~{userSelector.name}~</Center>
      </Center>
     </Center>
     ...
     <Center>
      <Box id="boxCheck" w={'350px'} padding={'15px'} borderRadius={'15px'}>
       <Flex justifyContent={'center'} flexDir={'column'} gap={'5px'}>
        ...
        <Center bg={'rgb(224,235,247)'} borderRadius={'15px'} color={'#787677'}>
